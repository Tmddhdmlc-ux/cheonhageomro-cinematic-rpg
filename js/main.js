(function(W){
  ...
  class Game{
    ...
    updateUI(){
      ...
      this.el["no-response"].classList.toggle("show",c.awaitingResponse);this.el["no-response"].disabled=!c.awaitingResponse||c.over;
    }
